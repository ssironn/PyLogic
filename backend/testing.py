import unittest
from utils.proposition import Proposition, CompoundProposition, parse_proposition, ParseError, TRUE, FALSE, TruthConstant
...
class TestBruteForceProver(unittest.TestCase):
    ...
    def test_prover_tracks_transformation_history(self):
        ...
        from utils.proposition import AtomicNode
